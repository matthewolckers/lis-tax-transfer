**********
* Version: 17B (France) * 14 November 2016 // NO IMPUTATIONS
**********
...
gen tax = hxiti + hxits // IMPUTATION // + hsscer + hic_csg_crds + pension_csg_crds

gen hssc = hxits + hxits // IMPUTATION // + hsscer

gen marketincome = hil + (hic-hicvip) + hxits // IMPUTATION // + hsscer + hic_csg_crds + pension_csg_crds		// For France, incomes are reported net of ssc, but gross of income tax
