...
label var allpension_conc_inc1 "Pension Concentration Coefficient (Primary Income)"
label var allpension_conc_inc2 "Pension Concentration Coefficient (Market Income)"
label var allpension_conc_inc3 "Pension Concentration Coefficient (Gross Income)"
label var allpension_conc_inc4 "Pension Concentration Coefficient (Disposable Income)"
label var pubpension_conc_inc1 "Public Pension Concentration Coefficient (Primary Income)"
label var pubpension_conc_inc2 "Public Pension Concentration Coefficient (Market Income)"
label var pubpension_conc_inc3 "Public Pension Concentration Coefficient (Gross Income)"
label var pubpension_conc_inc4 "Public Pension Concentration Coefficient (Disposable Income)"
label var pripension_conc_inc1 "Private Pension Concentration Coefficient (Primary Income)"
label var pripension_conc_inc2 "Private Pension Concentration Coefficient (Market Income)"
label var pripension_conc_inc3 "Private Pension Concentration Coefficient (Gross Income)"
label var pripension_conc_inc4 "Private Pension Concentration Coefficient (Disposable Income)"
