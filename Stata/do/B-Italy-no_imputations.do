**********
* Version: 17B (Italy) * 14 November 2016 // NO IMPUTATIONS
**********
...
global datasets "it04 it08 it10"  
  
global pvars "pid hid dname pil pxit pxiti pxits age"   
...
**********************************************************************  
* Program 1 (Italy): Generate SSC variables from person level dataset  
**********************************************************************  
...
// IMPUTATION // replace hxits=hsscee if hxits==.  
...
replace hxit = hxiti + hxits if hxit==.  										// For France I used hxit, and hxits. See the discussion in the France do file. Perhaps, I should use the same strategy here.
...
gen tax = hxit // IMPUTATION // + hsscer

gen hssc = hxits // IMPUTATION // + hsscer  
  
gen marketincome = hil + (hic-hicvip) + tax										// This is different to the gross datasets, which are reported net of employer contributions but gross of income tax.
