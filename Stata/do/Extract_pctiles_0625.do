...
foreach ccyy in $datasets {
  ...
  foreach var in $hvarsinc $hvarsflow $hvarsnew {
	...
	foreach var2 in $incconcept{
		...
		quietly egen `var'_min_`var2'=min(`var2'), by(pctile_`var2') 
		quietly egen `var'_max_`var2'=max(`var2'), by(pctile_`var2') 
 ...
 keep countryyear pctile_`sortvar' `sortvar'_mean_`sortvar' `sortvar'_min_`sortvar' `sortvar'_max_`sortvar' hxit_mean_`sortvar' hxits_mean_`sortvar' hsscer_mean_`sortvar' hil_mean_`sortvar' transfer_mean_`sortvar' pubpension_mean_`sortvar'
