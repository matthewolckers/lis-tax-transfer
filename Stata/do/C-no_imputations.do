**********
* Version: 17C * 14 November 2016 // NO IMPUTATIONS
**********
...
// IMPUTATION // replace hxiti=hinctax if hxiti==.
...
gen marketincome = hil + (hic-hicvip) + tax // IMPUTATION // + hsscer			// This is different definition to the gross datasets
